...
```bash
./SqlPackage /Action:Publish /SourceFile:bin/Debug/Northwind.TradingPost.Database.dacpac /TargetServerName:localhost /TargetDatabaseName:Northwind.TradingPost.Database
```
