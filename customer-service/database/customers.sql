/*
Creates the "customer_service" schema, user, and objects.
This script is idempotent and destructive. It will not fail if run consecutive times, but will drop and
recreate any objects.

The CustomerService component/microservice is dependent on this schema and its objects. Run this script first against
your PostgreSQL database.
*/

DO $$
BEGIN 
    CREATE USER customer_owner PASSWORD 'Password1';
...
DROP TABLE IF EXISTS customer_service.customers;
